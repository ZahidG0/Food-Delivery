...
const Navbar = () => {
  return (
    <div className='w-full h-24 flex items-center justify-between px-10 bg-gray-100 shadow-md'>
      ...
      {/* Search Bar */}
      <form action="" className='flex items-center justify-between w-1/2 h-16 gap-8 px-4 bg-white rounded-lg shadow-md'>
        <IoSearch className='text-3xl text-green-500' />
        <input type="text" placeholder='Search food items...' className='w-full text-xl h-full outline-none' />
      </form>
